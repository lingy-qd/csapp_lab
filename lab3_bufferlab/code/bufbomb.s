...
08048d60 <bang>:
 ...
 8048d72:	a1 dc a1 04 08       	mov    0x804a1dc,%eax //global value
 8048d77:	3b 05 cc a1 04 08    	cmp    0x804a1cc,%eax //cookie: 比较cookie和global value
 8048d7d:	74 21                	je     8048da0 <bang+0x40>
 8048d7f:	89 44 24 04          	mov    %eax,0x4(%esp)
 8048d83:	c7 04 24 0b 9a 04 08 	movl   $0x8049a0b,(%esp)//Misfire
 ...
 8048da4:	c7 04 24 70 98 04 08 	movl   $0x8049870,(%esp) //bang: 这里是正确的
...
08048dc0 <fizz>:
 ...
 8048dc7:	8b 5d 08             	mov    0x8(%ebp),%ebx // 参数val
 8048dca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 8048dd1:	e8 ca fb ff ff       	call   80489a0 <entry_check>
 8048dd6:	3b 1d cc a1 04 08    	cmp    0x804a1cc,%ebx // cookie
 8048ddc:	74 22                	je     8048e00 <fizz+0x40> // 应该跳转
 8048dde:	89 5c 24 04          	mov    %ebx,0x4(%esp)
 8048de2:	c7 04 24 98 98 04 08 	movl   $0x8049898,(%esp) // Misfire
 ...
 8048e04:	c7 04 24 29 9a 04 08 	movl   $0x8049a29,(%esp) // Fizz!
...
08048fe0 <getbuf>:
 ...
 8048fe9:	89 04 24             	mov    %eax,(%esp) // Gets的参数是$eax，存放在($esp)中
 8048fec:	e8 6f fe ff ff       	call   8048e60 <Gets>
 8048ff1:	b8 01 00 00 00       	mov    $0x1,%eax
 8048ff6:	c9                   	leave  // $esp=$ebp+4,$ebp=old ebp
 8048ff7:	c3                   	ret  // return to (ebp+0x4)  
 8048ff8:	90                   	nop
...
08049000 <test>:
 ...
 8049019:	e8 c2 ff ff ff       	call   8048fe0 <getbuf> //todo:entry
 804901e:	89 c2                	mov    %eax,%edx
 8049020:	8b 45 fc             	mov    -0x4(%ebp),%eax //检查栈是否被破坏
...
08049070 <launch>:
 ...
 8049100:	e8 fb fe ff ff       	call   8049000 <test> //todo:entry
